...
- Поля title и content НИКОГДА не могут быть пустыми, null, "..." или состоять из одного слова. Если данных по документу мало, всё равно сгенерируй развёрнутый осмысленный title (новостной заголовок) и content (HTML-статья из 3+ разделов с h2, lead-абзацем и aside).
...
{
  "title": "новостной заголовок до 80 символов, не пустой",
  "slug": "translit-url-slug-latin",
  "previewText": "развёрнутое превью 350-550 символов, 4-6 предложений, не пустое",
  "content": "полный HTML-текст статьи с <p class=\"lead\">, <h2>, <p>, <aside class=\"article-note\">, <p class=\"article-source\"> и <p class=\"article-disclaimer\">. Не пустой, минимум 3 раздела.",
  "metaTitle": "SEO title до 60 символов, не пустой",
  "metaDescription": "SEO description до 160 символов, не пустой",
