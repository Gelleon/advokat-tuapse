...
# Nginx: long-cache для /assets и /fonts (скрипт в репозитории, ищет конфиг по домену)
Run-Ssh "cd $REMOTE_DIR && chmod +x scripts/patch-nginx-cache.sh && DIST_ROOT=$REMOTE_DIR/dist bash scripts/patch-nginx-cache.sh"
